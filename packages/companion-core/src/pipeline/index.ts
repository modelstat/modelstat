/**
 * Companion pipeline — redact → tokenize → segment → summarise → tag.
 *
 ...
 * @modelstat/companion-core/redact/privacy-filter. Returns the same
...
// redact + summariser types from companion-core/pipeline.
