/**
 * Browser-only daemon adapters. Use from apps/extension.
 *
 * Mirrors @modelstat/daemon-core/node: same QueueStore contract,
 ...
 * Daemon apps wire their offscreen ML runtimes here so the
