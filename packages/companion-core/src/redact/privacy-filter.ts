 ...
 *
 * Builds a Redactor function that the companion pipeline runs AFTER
 ...
 * — which we don't depend on directly to keep companion-core's tree
 ...
 *
 * Companions that don't want the model (small CPU device, slow disk,
 ...
 * package (the companion CLI / browser extension repo) must add
