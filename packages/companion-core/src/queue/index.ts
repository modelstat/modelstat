 ...
 *
 * Both companions feed captured events into an IngestQueue with a
 ...
 * store impls live in @modelstat/companion-core/{node,browser} subpaths,
 ...
 * companion-core doesn't grow a dependency on the parsers package. */
...
export interface PipelineRunner {
   ...
   * flow via @modelstat/companion-core/pipeline. */
 ...
 * (the companion's tick loop) is responsible for actually uploading
...
async function finalise(args: {
  ...
  return {
    ...
    companion_version: args.companionVersion,
    events: args.events,
    segments,
