/**
 * Shared logger contract for daemons.
 *
 ...
 * `@modelstat/daemon-core/node/logger-pino` (declared in the daemon-
...
/**
 * Standard factory — daemons should call this rather than constructing
