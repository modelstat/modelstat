 ...
 * and browser daemons must produce vectors from the SAME model so a
 ...
 * filter, so this adds no new dependency footprint for daemons
 * that have both adapters wired.
 *
 * Browser counterpart lives in packages/daemon-core/src/browser/
